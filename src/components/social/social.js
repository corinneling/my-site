...
const Social = () => {
  return (
    <div className="cmp-social">
      <a className="cmp-social__item" href="https://codepen.io/corinneling/" aria-label="My Codepen">
      ...
      <a className="cmp-social__item" href="https://github.com/corinneling" aria-label="My GitHub">
      ...
      <a className="cmp-social__item" href="mailto:corinnealing@gmail.com" aria-label="My Email">
